...
public class WebMail {
	...
	public static void sendmail() {
		...
		try {
			...
			Address fromAddress = new InternetAddress("farhangbehnam06@gmail.com", "Behnam");
			currentMessage.setFrom(fromAddress);
			// 5) Set the message's To: address
			Address toAddress = new InternetAddress("bfarhangmehr1@nait.ca", "Behnam farhangmehr -NAIT Account ");
